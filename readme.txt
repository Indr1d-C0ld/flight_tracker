...
flight_tracker è un progetto di raccolta e consultazione dei contatti ADS-B, pensato per girare su un 
sistema come un Raspberry Pi (o altra distribuzione Linux) dotato di un ricevitore ADS-B e di un software 
come tar1090 / readsb / dump1090. Il cuore del sistema è un database SQLite che registra i dati dei voli, e 
uno script Bash che permette di interrogarlo, visualizzare statistiche, salvare o stampare i risultati.
...
classifiche (top altitudine, top velocità, etc.) e funzioni dedicate (voli militari, emergenza squawk, voli 
a terra, statistiche di database).
...
condividerlo con altre persone interessate al monitoraggio ADS-B, alle statistiche sui voli e a una gestione 
“gamificata” (con rarità) dei contatti aerei.
